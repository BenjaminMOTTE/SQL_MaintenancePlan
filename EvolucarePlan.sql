...
BEGIN
  ...
  BEGIN
    ...
    EXECUTE msdb.dbo.sp_add_jobstep @job_name = @JobName04, @step_name = @JobName04, @subsystem = 'CMDEXEC', @command = @JobCommand04, @output_file_name = @OutputFile04, @step_id=1, 
		...
		@retry_attempts=3, 
		@retry_interval=1
	EXECUTE msdb.dbo.sp_add_jobschedule @name=N'Sauvegarde des LOG', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=8, 
